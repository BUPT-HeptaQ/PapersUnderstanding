...
# (1) The size of the partial frame is (2*0.18*W, 2*0.18*H);
# (2) The size of the partial frame is (2*0.16*W, 2*0.16*H)
# LE: left eye; RE: right eye; N: nose; LM: left mouth; RM: right mouth
types = [(0, 'LE1', 0.16), (0, 'LE2', 0.18), (1, 'RE1', 0.16), (1, 'RE2', 0.18), (2, 'N1', 0.16),
         (2, 'N2', 0.18), (3, 'LM1', 0.16), (3, 'LM2', 0.18), (4, 'RM1', 0.16), (4, 'RM2', 0.18)]
# 5 key points, two padding
for t in types:
    path = './desktop/deep_landmark/mytrain/2_%s' % t[1]
    createDir(path)
...
def generate(ftxt, mode, argument=False):
    ...
    for idx, name, padding in types:
        ...
        with h5py.File('./desktop/deep_landmark/mytrain/2_%s/%s.h5' % (name, mode), 'w') as h5:
        ...
        with open('./desktop/deep_landmark/mytrain/2_%s/%s.txt' % (name, mode), 'w') as fd:
            fd.write('./desktop/deep_landmark/mytrain/2_%s/%s.h5' % (name, mode))
...
if __name__ == '__main__':
    ...
    # generate train.h5 and train.txt
